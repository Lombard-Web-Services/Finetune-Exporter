...
(function() {
    ...
    const platformHandlers = {
        ...
        grok: {
            ...
            getTitle: () => document.querySelector('title')?.textContent?.replace('Grok', '').replace('xAI', '').trim() || 'Grok_Chat'
        },
        grok_x: {
            getMessages: async () => {
                ...
                if (pairs.length === 0) {
                    ...
                    for (let i = 0; i < tweetTexts.length - 1; i += 2) {
                        if (tweetTexts[i] && tweetTexts[i + 1]) pairs.push({ user: tweetTexts[i], assistant: tweetTexts[i + 1] });
                    }
                }
                return pairs;
            },
    ...
    // ==================== 7. SVG BOUTON ====================
    // (Ré)tablir l’icône SVG "téléchargement" sur le bouton principal
    ...
    GM_addStyle(`
        ...
        .ai-export-menu-panel {
            position: absolute;
            min-width: 200px;
            /* Menu vertical + glassmorphism */
            display: none;
            flex-direction: column;
            /* Glassmorphism plus nuancé */
            background:
        ...
        /* Historique des exports - Style élégant */
    ...
    class FloatingButton {
        constructor() {
            ...
            // IMPORTANT: ne pas remplacer innerHTML (sinon on détruit le menu après un export)
        ...
        setExporting(isExporting) {
            ...
            if (this.isExporting) {
                ...
                this.labelEl.textContent = t('exporting');
        ...
        createMenu() {
            ...
            // Section Langue (dropdown dans dropdown)
            ...
            // Remplir le sous-menu avec les langues
        ...
        setupEvents() {
            ...
            // Pointer events = drag plus fluide (et gère touch/trackpad)
            this.box.addEventListener('pointerdown', (e) => {
                // Ne pas déclencher un drag si on clique dans le menu
            ...
            this.box.addEventListener('pointermove', (e) => {
                ...
                const newLeft = clamp(this.boxStartLeft + dx, 10, window.innerWidth - 110);
                const newTop = clamp(this.boxStartTop + dy, 10, window.innerHeight - 50);
            ...
            const endDrag = (e) => {
                ...
                // Si pas de drag réel => c'est un clic, toggle menu
    ...
    function initialize() {
        ...
        const urlObserver = new MutationObserver(() => {
            ...
            if (url !== lastUrl) {
                ...
                lastUrl = url;
                // Réinitialiser le menu lors du changement de page/conversation
